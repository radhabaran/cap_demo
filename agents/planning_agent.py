...
def initialize_planning_agent(llm_instance, chat_memory_instance, query_memory_instance):
    ...
    tools = [
        ...
        Tool(
            ...
            description="Use this for general queries not related to products. After this step, return the response to main.py"
        ),
    ...
    2. MOST IMPORTANT: Provide deatiled steps for each thought, action and observation.
    - Do not summarize
    - Do not modify
